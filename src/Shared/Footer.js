    ...
    return (
        ...
        <footer class="footer p-10 bg-neutral text-base-content">
            <div>
                ...
                <a class="text-base-100 link link-hover">Universal Mirror</a>
            </div> 
            <div>
                <a class="text-base-100 link link-hover">Mirror Glass With Plate</a> 
                <a class="text-base-100 link link-hover">Towing and Rear Under Mirror</a> 
            ...
            <div>
                ...
                <a class="text-base-100 link link-hover">Contact Us</a>
                <a class="text-base-100 link link-hover">Site Map</a>
            </div> 
            </footer> 
            <footer class="footer px-10 py-4 border-t bg-neutral text-base-content border-base-300">
            <div class="text-base-100 items-center grid-flow-col">
                ...
                <p class="text-base-100">Raiyan Auto Mirror Ltd. <br/>Providing reliable tech since 1992</p>
            </div> 
            <div class="md:place-self-center md:justify-self-end">
                <div class="text-base-100 grid grid-flow-col gap-4">
